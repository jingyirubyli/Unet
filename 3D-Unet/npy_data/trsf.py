...
dir="/Users/lijingyi/Desktop/npy_test/imgs"
...
def getFileArr(dir):
    ...
    for file in file_list:
        ...
        r_arr=np.array(r).reshape(230400)
        g_arr=np.array(g).reshape(230400)
    ...
    os.makedirs("/Users/lijingyi/Desktop/npy_test/npy")
    np.save('/Users/lijingyi/Desktop/npy_test/npy/test_data.npy', ret_arr)
    return ret_arr
